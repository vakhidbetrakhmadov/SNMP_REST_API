...
public class SnmpService implements AutoCloseable {
    ...
    public static final String COMMUNITY = "enter_your_community_here";
    ...
    public SnmpService(String community) throws IOException { this(community,3,3000L); }

    public SnmpService() throws IOException { this(COMMUNITY); }
